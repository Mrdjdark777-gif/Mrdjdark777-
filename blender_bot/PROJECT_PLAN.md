...
| 2 | Толерантность к опечаткам (Левенштейн/rapidfuzz, раздел 1.1) | ⬜ |
| 3 | Новые диагностические ветки: UV, запекание, симуляции (раздел 3.1) | ⬜ |
| 4 | BM25 вместо TF-IDF (раздел 1.1) | ⬜ |
