...
export function NativePodcastPlayer({src,title,duration=0,cover,autoplay=true,onClose}:{src:string;title:string;duration?:number;cover?:string;autoplay?:boolean;onClose:()=>void}){
