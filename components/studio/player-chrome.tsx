...
import {Play,Pause,RotateCcw,RotateCw,Loader2,X,ChevronDown,ChevronUp,MoreHorizontal,Heart,Timer} from 'lucide-react';
 ...
 * разметка. S04 и S06 достраиваются следующими шагами и пока показываются
 * тем же корпусом без фотографии — не пустым макетом.
 */
