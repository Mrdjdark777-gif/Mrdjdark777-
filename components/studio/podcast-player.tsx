...
type Props={src:string;title:string;duration?:number;cover?:string;note?:string;archived?:boolean;supportUrl?:string;onShare?:()=>void;from?:PlayFrom;next?:{id:string;title:string;cover?:string;duration:number}|null;onNext?:(id:string)=>void;audioRef:RefObject<HTMLAudioElement|null>;autoplay?:boolean;expanded?:boolean;onExpand?:(next:boolean)=>void;onClose:()=>void};

function WebPodcastPlayer({src,title,duration:initialDuration=0,cover,note,archived,supportUrl,onShare,from='begin',next,onNext,audioRef,autoplay=true,expanded=true,onExpand=()=>{},onClose}:Props){
