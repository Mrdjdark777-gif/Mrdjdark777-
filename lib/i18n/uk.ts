...
export const uk: Record<keyof typeof ru, string> = {
  ...
  "editor.coverNote": "Вертикальна обкладинка 4:5 — 1080×1350, JPEG. Головне тримай у центральному квадраті: у колі плеєра та у сповіщенні видно лише середину. Інше співвідношення не обріжеться, але ляже з полями.",
  ...
  "breath.out": "Видих",
  "breath.note": "Дихай за колом: 4 рахунки вдих, 4 затримка, 4 видих, 4 затримка. Півтори хвилини знімають тривогу.",
  ...
  "post.pin": "Закріпити на головній",
  "post.unpin": "Зняти з головної",
  "post.pinned": "Закріплено на головній",
  "post.unpinned": "Знято з головної",
  ...
  "settings.artTitle": "Фон сповіщень",
  "settings.calmTitle": "Картинка кола спокою",
  "settings.calmText": "Стоїть у колі на екрані ефіру, коли ефіру немає, — під нею йде дихальне коло 4-4-4-4. Обери те, на що тобі спокійно дивитися.",
  "settings.calmNote": "Квадрат 1:1 — 1080×1080, JPEG. Коло вирізається із середини, тож головне тримай по центру. До 12 МБ.",

  "settings.artText": "Картинка показується у сповіщенні про фонове відтворення — як обкладинка альбому на екрані блокування. Підійде банер твого каналу.",
  ...
  "settings.artNote": "Горизонтальний банер 16:9 — 1920×1080, до 12 МБ. Середину тримай спокійною: поверх неї малюються написи.",
  ...
  "notif.note": "Сповіщення приходять і без відкритого застосунку. Якщо не приходять — перевір дозволи та енергозбереження в налаштуваннях Android.",
