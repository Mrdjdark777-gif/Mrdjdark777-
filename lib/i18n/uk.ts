...
export const uk: Record<keyof typeof ru, string> = {
  ...
  "live.coverNote": "Вертикальна обкладинка 9:16 — наприклад 1080×1920. Стає обкладинкою випуску в подкастах. Без неї фоном ефіру буде картинка каналу з налаштувань, а на картці — логотип.",
