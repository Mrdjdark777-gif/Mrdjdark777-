...
export const uk: Record<keyof typeof ru, string> = {
  ...
  "live.coverNote": "Вертикальна обкладинка 9:16 — наприклад 1080×1920. Показується слухачам на сторінці ефіру й залишається обкладинкою випуску в подкастах. Якщо не завантажити — візьметься загальний банер каналу.",
