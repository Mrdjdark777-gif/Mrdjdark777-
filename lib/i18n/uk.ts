...
export const uk: Record<keyof typeof ru, string> = {
  ...
  // Спільнота: профіль слухача, коментарі ефіру та модерація.
  "donate.supportAuthor": "Підтримати автора",
  "donate.voluntaryNote": "Добровільно · увесь вміст залишається безкоштовним",
  "donate.voluntaryTitle": "Добровільна підтримка, без подарунків і привілеїв",
  "community.profile": "Профіль",
  "community.pageTitle": "Профіль і видалення даних — True Thrills",
  "community.loading": "Завантаження профілю…",
  "community.profileTitle": "Профіль слухача",
  "community.saveCode": "Збережіть особистий код входу",
  "community.saveCodeNote": "Він замінює пароль. Не публікуйте його. Без коду й діючого входу відновити профіль неможливо.",
  "community.copyCode": "Копіювати код",
  "community.codeCopied": "Код скопійовано.",
  "community.saveToFile": "Зберегти файлом",
  "community.codeFileNote": "True Thrills — особистий код входу. Не передавайте іншим.",
  "community.codeSaved": "Я зберіг код",
  "community.bannedNote": "Публікацію повідомлень обмежено. Для оскарження: {contact}",
  "community.exportLabel": "Ваші дані — можна виділити й скопіювати",
  "community.logout": "Вийти",
  "community.download": "Завантажити мої дані",
  "community.blocked": "Заблоковані учасники",
  "community.unblock": "Розблокувати",
  "community.deleteProfile": "Видалити профіль",
  "community.deleteConfirm": "Видалити профіль, усі ваші коментарі та завершити всі входи? Цю дію не можна скасувати.",
  "community.deleteYes": "Так, видалити все",
  "community.anonymous": "Профіль без імені, пошти й телефону. Застосунок створить псевдонім і видасть код для входу.",
  "community.rules": "Правила: без погроз, цькування, спаму, незаконних матеріалів і чужих персональних даних. Повідомлення перевіряє модератор; порушення може призвести до видалення повідомлення або блокування. Скарги й оскарження: {contact}.",
  "community.acceptRules": "Приймаю правила спільноти",
  "community.createProfile": "Створити профіль",
  "community.haveProfile": "Уже є профіль?",
  "community.codePlaceholder": "Особистий код входу",
  "community.loginByCode": "Увійти за кодом",
  "community.privacyLink": "Як обробляються дані",
  "community.contactNote": "Підтримка та запити на видалення даних: {contact}",
  "community.commentsTitle": "Коментарі ефіру",
  "community.commentsNote": "Коментарі публікуються одразу. Автор може видалити порушення.",
  "community.pending": "На перевірці",
  "community.rejected": "Відхилено",
  "community.remove": "Видалити",
  "community.report": "Поскаржитися",
  "community.blockMember": "Заблокувати учасника",
  "community.reportReason": "Причина скарги",
  "community.reasonAbuse": "Образи / погрози",
  "community.reasonSpam": "Спам",
  "community.reasonPrivacy": "Чужі особисті дані",
  "community.reasonIllegal": "Незаконний матеріал",
  "community.reasonOther": "Інше",
  "community.sendReport": "Надіслати скаргу",
  "community.reportSent": "Скаргу надіслано модератору.",
  "community.yourComment": "Ваш коментар",
  "community.commentPlaceholder": "Без посилань і особистих даних",
  "community.send": "Надіслати",
  "community.published": "Коментар опубліковано.",
  "community.liveEnded": "Ефір завершено.",
  "community.moderationTitle": "Модерація ефірів",
  "community.reportsCount": "скарг: {n}",
  "community.reasonPrompt": "Причина, яку побачить учасник:",
  "community.actPublish": "Відновити",
  "community.actReject": "Видалити з ефіру",
  "community.actBan": "Заблокувати",
  "community.actDismiss": "Закрити скаргу",
  "community.actUnban": "Розблокувати",
  "community.errUnauthorized": "Увійдіть у профіль.",
  "community.errInvalidCode": "Код входу не знайдено.",
  "community.errRateLimit": "Занадто часто. Зачекайте й спробуйте ще раз.",
  "community.errInvalidComment": "Від 1 до 500 символів, без посилань.",
  "community.errLiveEnded": "Ефір уже завершено.",
  "community.errBanned": "Надсилання повідомлень обмежено модератором.",
  "community.errRulesRequired": "Прийміть правила.",
  "community.errDisabled": "Реєстрація тимчасово недоступна.",
  "community.errConflict": "Повтор запиту відрізняється від початкового. Оновіть сторінку.",
  "community.errOffline": "Сервіс тимчасово недоступний.",

  // Правові сторінки та відповідальний за дані.
  "legal.updated": "Остання зміна",
  "legal.draft": "Документ ще не заповнено: не вказано відповідального за дані та адресу для зв’язку. До того він не діє, а спільнота лишається вимкненою.",
  "legal.privacy": "Політика конфіденційності",
  "legal.rules": "Правила та умови",
  "settings.legalTitle": "Відповідальний за дані",
  "settings.legalText": "Ім’я або назва та адреса для зв’язку, які побачать люди в політиці конфіденційності та в правилах. Без них документи не діють, а спільнота не ввімкнеться.",
  "settings.legalName": "Ім’я або назва",
  "settings.legalContact": "Адреса для зв’язку",
  "settings.legalSave": "Зберегти",
  "settings.legalSaved": "Відповідального за дані збережено",
