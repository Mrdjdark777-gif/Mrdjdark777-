 ...
 * и обе вкладки были неотличимы. Настройки задают раз и почти не трогают, а
 * при открытии студии автору нужно другое: что недоделано и что последним
 * ушло к слушателям.
 */
// published приходит из SQLite числом (0/1), поэтому здесь читается по
// истинности, а не как boolean.
