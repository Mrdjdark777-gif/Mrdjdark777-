...
export default function Studio(){
 ...
 {view==='home'&&!author&&<HomeSceneView posts={homePosts} live={liveStatus} onOpen={openPost} onOpenLive={openLive} appLink={appLink}
...
{data&&!data.needsSetup&&<nav className="bottom-nav">
 ...
 {playing&&<PodcastPlayer key={playing.id} src={'/api/audio?id='+playing.id} title={playing.title} duration={playing.duration} cover={coverSrc(playing)||undefined} note={playing.description||undefined} archived={isLiveArchive(playing.audioKey)} supportUrl={heartLink?.url} onShare={()=>void share('/?mode=listen&post='+playing.id,playing.title)}
