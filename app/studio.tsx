...
export default function Studio(){
 ...
 <button className="home-tile" onClick={()=>void copyChannelLink()}>{wide?<LiquidMetalButton viewMode="icon" size={44} interactive={false} icon={<Share2 size={19} color="#6FE7DE"/>}/>:<Share2 size={22}/>}<span>{t('home.shareChannel')}</span></button>
 </div>}
