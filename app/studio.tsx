...
type Data={items:Post[];isOwner:boolean;needsSetup:boolean;signedIn:boolean;donations:DonationLink[];links:SocialLink[];live:{id:string;title:string;startedAt:number|null;cover:boolean}|null;pinned:string|null;calmArt?:string|null};
