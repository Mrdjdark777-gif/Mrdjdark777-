...
public class PlaybackService extends MediaSessionService {
    ...
    @Override public void onCreate() {
        ...
        player.addListener(new Player.Listener() { @Override public void onIsPlayingChanged(boolean playing) { save(); } });
    ...
    @Override public void onDestroy() {
        handler.removeCallbacks(tick); save(); session.release(); player.release(); super.onDestroy();
    }
}
